...
function SignUp() {
  ...
  const handleSignUp = async () => {
    ...
    await postUser({ pseudo, password, confirmPassword, lastname, firstname } ) && setTimeout(() => {toLogIn()}, 1000) && setTimeout(() => {toast.dismiss();navigate('/')}, 6000); //L'utilisation de '&&' garantit que chaque étape suivante n'est exécutée que si la précédente réussit ou se termine correctement.
